...
<footer>
		<div class="container py-4">
			<div class="row py-xl-5 py-sm-3">
				<div class="col-lg-6 map">
					...
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3596.892795572555!2d85.05968587427583!3d25.641683313556108!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39ed57e322e8a841%3A0xeb47efab005f4f0a!2sDeepak%20Computer%20Typing!5e0!3m2!1sen!2sus!4v1700117922242!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
					<div class="conta-posi-w3ls p-4 rounded">
						<h5 class="text-white font-weight-bold mb-3">Address</h5>
						<p>Chak Mussalahpur,
							<span>Post - Mahendru,</span> Patna, Bihar,<br> Pin Code 800006</p>
					</div>
				</div>
				<div class="col-lg-6 contact-agileits-w3layouts mt-lg-0 mt-4">
					...
					<p class="para-agileits-w3layouts text-white">
						<i class="fas fa-map-marker pr-3"></i>Mahendru, Patna, Bihar</p>
					<p class="para-agileits-w3layouts text-white my-sm-3 my-2">
						<i class="fas fa-phone pr-3"></i>+917004182625</p>
					<p class="para-agileits-w3layouts">
						<i class="far fa-envelope-open pr-2"></i>
						<a href="mailto:mail@example.com" class=" text-white">dcgplpt@gmail.com</a>
					</p>
				</div>
			</div>
		</div>
		<div class="copyright-agiles py-3">
			<div class="container">
				<div class="row">
					<p class="col-lg-8 copy-right-grids text-white text-lg-left text-center mt-lg-1">© 2023 DCGYAN. All Rights Reserved | Design by 
						<a href="#" target="_blank">DGHUB</a>
					</p>
					<!-- social icons -->
